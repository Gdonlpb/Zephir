...
AutoUpdate.set_current_version("0.0.0.3")
AutoUpdate.set_download_link("https://raw.githubusercontent.com/Gdonlpb/Zephir/main/version.txt")
if AutoUpdate.is_up_to_date() == False:
    AutoUpdate.download("version.txt")
    print("Updating")
